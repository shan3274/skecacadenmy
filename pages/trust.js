    ...
    <div>
      ...
      <div className="w-full min-h-screen relative top-[5rem] flex items-center justify-center flex-col gap-5 mt-[10vh]  mb-[20vh]">
        <div className="w-[80%] min-h-screen flex items-center justify-center gap-10 flex-col">
          <h1 className="lg:text-[40px] text-[30px] text-center lg:text-start font-Comfortaa">{data?.title}</h1>
          <div className="lg:w-[90%] min-h-[50vh] lg:flex-row flex-col flex items-center justify-around flex-wrap gap-5">
            <Image
              loader={() => (image = image)}
              src={image}
              width={0}
              height={0}
              className="rounded-lg drop-shadow-xl lg:w-[25%] w-[90%]"
            />
            <div className="lg:w-[60%] h-full flex flex-col  p-5 gap-5">
          ...
          <div className="w-full min-h-[50vh] flex items-center flex-col justify-around flex-wrap gap-5">
            <h1 className="font-Comfortaa text-blue-600 lg:text-[25px]  text-[20px] text-center lg:text-start">
              {" "}
              {data?.heading2}
            </h1>
            <Image
